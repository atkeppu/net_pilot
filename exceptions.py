class NetworkManagerError(Exception):
    ...
    Attributes:
        ...
        code (str | None): An optional machine-readable error code for specific error handling.
    """
    ...
    def __str__(self) -> str:
        """Return the string representation of the error, including the code if present."""
        if self.code:
