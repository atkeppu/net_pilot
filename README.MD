...
Projekti käyttää `flake8`- ja `mypy`-työkaluja koodin laadun ja tyyppiturvallisuuden varmistamiseksi. Voit suorittaa tarkistukset manuaalisesti komennolla:

*   **Tarkista koodin tyyli ja yleiset virheet `flake8`:lla:**
    ```bash
    flake8 .
    ```
