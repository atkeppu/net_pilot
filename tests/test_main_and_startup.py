...
class TestMainStartup(unittest.TestCase):
    ...
    @patch('main.NetworkManagerApp')
    def test_main_relaunch_as_admin(self, mock_app, mock_relaunch, mock_is_admin, mock_init_lang, mock_logging):
    ...
    @patch('main.messagebox.showerror')
    def test_main_relaunch_fails(self, mock_showerror, mock_relaunch, mock_is_admin, mock_init_lang, mock_logging):
    ...
    @patch('main.messagebox.showerror')
    def test_main_generic_exception_path(self, mock_showerror, mock_app, mock_is_admin, mock_init_lang, mock_logging):
        ...
        self.assertIn(main.get_string("fatal_error_title"), mock_showerror.call_args.args)